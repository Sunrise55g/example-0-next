                  ...
                  >
                    ...
                    <form action="">
                      ...
                      <div className="flex items-center justify-between mb-2">
                        <div className="w-full flex items-center row">
                          <div className="col-6 w-full">
                            <div className="flex items-center gap-3">
                              <p>InvoiceName</p>
                            </div>
                      ...
                      <div className="w-full rounded-md flex items-center justify-between bg-blue-300 p-3 mt-2">
                        <div className="w-full flex items-center">
                          <div className="flex items-center gap-3">
                            <p>Customer</p>
                          </div>
                      ...
                      <div className="w-full rounded-md flex items-center justify-between bg-red-300 p-3 mt-2 mb-4">
                        <div className="w-full flex items-center">
                          <div className="flex items-center gap-3">
                            <p>Employer</p>
                          </div>
