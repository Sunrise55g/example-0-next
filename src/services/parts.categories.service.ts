...
export type IPartsCategoriesServiceCoreState = {
	errors?: {};
	message?: string;
};
...
class PartsCategoriesServiceCore {
	private BASE_URL = '/profile/users/core'


	async profileUsersCreateOne(prevState: IPartsCategoriesServiceCoreState, data: FormData) {
...
export const partsCategoriesServiceCore = new PartsCategoriesServiceCore()
